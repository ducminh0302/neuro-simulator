...
import { Card, Pill, SectionHeading, StatCard, Surface } from "@/components/ui";
...
const recentSimulations = [
  { name: "Afterboards CUET/IPMAT Evaluation", meta: "Video + Neural Prediction Deep Simulation" },
